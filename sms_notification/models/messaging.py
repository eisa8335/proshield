...
class stock_picking(models.Model):
    ...
    def write(self, vals):
        ...
        for res in self:
            ...
            elif res.partner_id.phone:
                mobile = res.partner_id.phone
            if res and mobile and vals.get("date_done", False):
                sms_template_objs = self.env["sms.template"].sudo().search(
    ...
    def write(self, vals):
        ...
        for res in self:
            ...
            if res.partner_id.mobile:
                ...
                mobile = res.partner_id.phone
            if res and mobile and vals.get("state", False) in ["open", "paid"]:
